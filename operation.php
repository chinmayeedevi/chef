<?php include "include/header.php" ?>
        ...
        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <div class="shopping-cart-block ptb-100 food-menu-block product-block-carousel-nav bg-image bg-overlay" style="background-image:url('assets/images/home/operation-bg.jpg')">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-title section-default text-center">
                            <h2 class="title-main">Operations Set Up</h2><!-- /.title-main -->
                        </div><!-- /.section-title -->
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="shop-table table">
                                <thead>
                                    <tr style="background-color: #c51c23;">
                                        <th class="product-name" style="width:40%">Aspects</th>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title section-default text-center">
                            <h2 class="title-main">MONITORING FOR SUCCESS - MONITORING & CONTROL</h2><!-- /.title-main -->
                        </div><!-- /.section-title -->
                    </div>
                </div>
                <div class="row">
