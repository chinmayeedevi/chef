...
<head>
    ...
    <!-- Titles
    ================================================== -->
    <title>Chef Faruk | HOTEL RESTAURANT & FOOD CONSULTANT </title>
    ...
    <!-- Custom Font
    ================================================== -->
    <link href="https://fonts.googleapis.com/css2?family=Herr+Von+Muellerhoff&amp;family=Playfair+Display:ital,wght@0,400;0,700;1,400;1,700&amp;family=Aguafina+Script&amp;family=Poppins:wght@300;400;500;600;700&amp;family=Oswald:wght@300;400;700&amp;display=swap"
        rel="stylesheet">
                        ...
                        <div class="col-12">
                            <div class="site-navigation">
                                <div class="site-branding">
                                    <a href="index.php">
                                        <img src="assets/images/logo/chef-w.png" alt="Site Logo" />
                                    </a>
                                </div><!-- /.site-branding -->
                                        ...
                                        <div class="menu-content">
                                            <ul class="mainmenu">
                                                ...
                                                <li>
                                                    <a>Gallery</a>
                                                    <ul class="sub-menu">
                                                        <li><a href="image.php">Piture</a></li>
                                                ...
                                                <li>
                                                    <a href="Brochure CFS FLAVOURS.pdf" target="_blank">Brochure </a>
                                                </li>
